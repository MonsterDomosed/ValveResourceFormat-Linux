...
namespace GUI.Utils
{
    ...
    public static class Settings
    {
        ...
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2227:Collection properties should be read only", Justification = "Setters are required for KeyValues deserialization.")]
        ...
        /// <summary>The update channel this build belongs to.</summary>
        public static UpdateChannel BuildChannel => AppInfo.IsReleaseBuild ? UpdateChannel.Stable : UpdateChannel.Dev;
        ...
        {
            SettingsFolder = PlatformServices.Current.SettingsDirectory;
            ...
            if (Config.Update.Version != AppInfo.ProductVersion)
            {
                Config.Update.Version = AppInfo.ProductVersion;
                Config.Update.UpdateAvailable = false;
                Config.Update.NextCheck = string.Empty;
                Config.Update.Channel = BuildChannel;
            }
