...
/// <summary>
/// Linux model viewer: a real GL viewport tab plus the portable resource data tabs. The GL tab renders
/// through the shared <see cref="GUI.Linux.Types.GLViewers.GLSceneViewerCore"/>.
/// </summary>
internal sealed class ModelGlViewer : IViewer
{
    ...
    public ViewerContent GetContent()
    {
        List<ViewerTab> tabs =
        [
            new ViewerTab("MODEL", new ViewerContent.GlViewport(() => new ModelGlRenderer(fileName)), Select: true),
        ];
